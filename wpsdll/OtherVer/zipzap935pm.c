...
#define ZZMAXPATH     512
#define MINZIPSIZE       22
#define ZZSTACKSIZE   32768
                                                  ...
                                                  PDRAGINFO pdrgInfo)
{
    ...
    return (zipzapfile_parent_WPDataFile_wpDragOver(somSelf, 
                                                    hwndCnr, 
                                                    pdrgInfo));
}
                                                      ...
                                                      ULONG iPosition)
{
    ...
    return (zipzapfile_parent_WPDataFile_wpModifyPopupMenu(somSelf, 
                                                           hwndMenu, 
                                                           hwndCnr, 
                                                           iPosition));
}
                                                       ...
                                                       ULONG ulMenuId)
{
    ...
    return (zipzapfile_parent_WPDataFile_wpMenuItemSelected(somSelf, 
                                                            hwndFrame, 
                                                            ulMenuId));
}
                                                        ...
                                                        ULONG iPosition)
{
    ...
    return (zipzapfolder_parent_WPFolder_wpModifyPopupMenu(somSelf, 
                                                           hwndMenu, 
                                                           hwndCnr, 
                                                           iPosition));
}
                                                         ...
                                                         ULONG ulMenuId)
{
    ...
    return (zipzapfolder_parent_WPFolder_wpMenuItemSelected(somSelf, 
                                                            hwndFrame, 
                                                            ulMenuId));
}
                                             ...
                                             ULONG param)
{
    ...
    return (zipzapfolder_parent_WPFolder_wpOpen(somSelf, hwndCnr, 
                                                ulView, param));
}
